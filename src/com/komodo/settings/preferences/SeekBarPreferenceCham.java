...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String KOMODOSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, KOMODOSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, KOMODOSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(KOMODOSETTINGSNS, "interval");
            if(newInterval != null)
