...
public class CarrierLabel extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mShowCarrierLabel.setEntries(KomodoUtils.hasNotch(getActivity()) ? NotchEntries : NonNotchEntries);
        mShowCarrierLabel.setDefaultValue("1");
        mShowCarrierLabel.setEntryValues(KomodoUtils.hasNotch(getActivity()) ? NotchValues : NonNotchValues);
